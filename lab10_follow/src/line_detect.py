...
class MultiDotDetect:
    ...
    def detect(self, img_msg):
        ...
        centroids, _, _ = self.logr.find_all_targets(prob_target)        
    ...
    def publish_centroids(self, centroids, imgheader):
        ...
        for cen in centroids:
            pa.points.append(Point(cen[0],cen[1]+210,0))
        self.pub.publish( pa )
...
if __name__ == '__main__':
    ...
    #lr.print_params()
    lr.set_model([[ 0.13762717,0.10048926,-0.22001517]],np.array([-9.27961815]))
